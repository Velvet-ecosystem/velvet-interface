...
"""Protected owner-maintenance scene for the hidden Backroom layer.
...
class OwnerMaintenanceScene(Scene):
    ...
    def __init__(
        ...
        *,
        ...
        scene_id: str = "owner_maintenance",
        display_title: str = "OWNER MAINTENANCE",
    ) -> None:
        ...
        self.display_title = str(display_title).strip() or "OWNER MAINTENANCE"
        self._router = None
        self._surface = None
        self._widget = None
    ...
    def _render_locked(self, surface: Any) -> Any:
        ...
        widget.setObjectName("ownerMaintenanceLocked")
    ...
    def _render_unlocked(self, surface: Any) -> Any:
        ...
        panel = QWidget(widget)
        panel.setObjectName("ownerMaintenancePanel")
        panel.setGeometry(int(width * 0.16), int(height * 0.10), int(width * 0.68), int(height * 0.80))
        panel.setStyleSheet(
            "QWidget#ownerMaintenancePanel { background: rgba(7, 8, 12, 224); "
        ...
        title = QLabel(self.display_title)
        title.setObjectName("title")
        title.setAlignment(Qt.AlignCenter)
        ...
        note = QLabel(
            "This room is the protected owner-maintenance layer behind the Backroom. "
